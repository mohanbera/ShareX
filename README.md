...
<h2>If not connected to the other device connect it first. Now you can see the number of files you have selected, now click on 'SEND' to send these files.</h2>
